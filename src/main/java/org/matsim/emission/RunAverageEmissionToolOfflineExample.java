...
public final class RunAverageEmissionToolOfflineExample{
	...
	private static final String eventsFile =  "./examples/event_modified/buildings_modified.xml";

	/* package, for test */ static final String emissionEventOutputFileName = "building.xml.gz";
